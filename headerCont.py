...
TRAIN = True                # wether or not "cnn.py' trains the model or predicts a mask
NEW = False                 # wether or not "cnn.py" trains a new model or continues an old one
...
ANGLE_STD = 30              # std for roation of fingerprint
